...
function Signup({ user, setUser }) {
  ...
  const errorElements = errors.errors.map((error) => (
    <div key={error} className="alert alert-danger error-messages" role="alert">
      {error}
    </div>
  ));
    ...
    <div>
      <div id="signup-div">
        <form onSubmit={onSignup} id="signup-form" noValidate>
          ...
          <div className="input-group mb-3">
            <span className="input-group-text" id="Birthday">
              Birthday
            </span>
            <input
              type="date"
              ...
              onChange={(e) => updateForm(e, "birthday")}
              aria-label="Birthday"
          ...
          <div className="input-group mb-3">
            ...
            <input
              type={passwordViewToggled ? "text" : "password"}
