...
function NavBar({ user, onChangeTheme, theme }) {
  function logoutDropdown() {
    return (
      <div className="dropdown">
        <button
          className="btn btn-dark dropdown-toggle text-capitalize btn-lg me-4"
          type="button"
      ...
      <nav id="mobile-nav">
        ...
        <div className="collapse" id="navbarToggleExternalContent">
          <div className="bg-dark p-4">
            <div className="d-flex flex-column navbar">{returnLinks()}</div>
          </div>
        </div>
      </nav>
    </div>
